...
![normal-approximates-distribution-1](https://rafalab.github.io/dsbook/book_files/figure-html/normal-approximates-distribution-1.png)
...
The first important concept to learn is the _expected value_. In statistics books, it is common to use letter 
$E$ like this:
...
**If our draws are independent**, then the _standard error of the sum is given by the equation:
...
$\mid 1 - (-1) \mid \sqrt{10/19 \times 9/19}$ or:
```{r}
2 * sqrt(90)/19
```
