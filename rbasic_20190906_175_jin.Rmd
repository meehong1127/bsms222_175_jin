...
```
# 3.3 Exercises
What is the sum of the first 100 positive integers? The formula for the sum of integers 1 through n is  
...
Based on the result, what do you think the functions **seq**and **sum** do? You can use the help system: **_B_**
...
we evaluate the sqrt function. In R, you can evaluate a function inside another function. The evaluations happen from the inside out. Use one line of code to compute the log, in base 10, of the square root of 100.
```{r}
